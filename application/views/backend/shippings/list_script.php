...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_shipping_label' ),
		'message' =>  get_msg( 'shipping_delete_confirm_message' ),
		'no_only_btn' => get_msg( 'shipping_no_only_label' )
	);
	
	$this->load->view( $template_path .'/components/shipping_delete_confirm_modal', $data );
?>